...
CREATE TABLE "Processos" (
    ...
    "Pcss_ValorAcao" DECIMAL(10,2) NOT NULL,
    "Pcss_DataInicio" DATE NOT NULL,
    "Pcss_Status" VARCHAR(50) NOT NULL,
...
-- CreateTable
CREATE TABLE "ProcNaoJudiciais" (
    "id" SERIAL NOT NULL,
    "Pnjd_TipoPrazoId" INTEGER,
    "Pnjd_NumeroProcesso" CHAR(25) NOT NULL,
    "Pnjd_Processo_id" INTEGER NOT NULL,

    CONSTRAINT "ProcNaoJudiciais_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "DocumentosAnexados" (
    ...
    "Danex_Nome" VARCHAR(150) NOT NULL,
    "Danex_Documento" VARCHAR(255) NOT NULL,
    "Danex_Usuario" INTEGER NOT NULL,
...
CREATE TABLE "Transferencias" (
    ...
    "Tran_NumeroProcesso_id" INTEGER NOT NULL,
...
-- CreateIndex
CREATE UNIQUE INDEX "ProcNaoJudiciais_Pnjd_Processo_id_key" ON "ProcNaoJudiciais"("Pnjd_Processo_id");
...
-- AddForeignKey
ALTER TABLE "ProcAssuntos" ADD CONSTRAINT "ProcAssuntos_Pass_NumeroProcesso_id_fkey" FOREIGN KEY ("Pass_NumeroProcesso_id") REFERENCES "Processos"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ProcNaoJudiciais" ADD CONSTRAINT "ProcNaoJudiciais_Pnjd_TipoPrazoId_fkey" FOREIGN KEY ("Pnjd_TipoPrazoId") REFERENCES "TiposPrazos"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ProcNaoJudiciais" ADD CONSTRAINT "ProcNaoJudiciais_Pnjd_Processo_id_fkey" FOREIGN KEY ("Pnjd_Processo_id") REFERENCES "Processos"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ProcJudiciais" ADD CONSTRAINT "ProcJudiciais_Pjud_NumeroProcesso_id_fkey" FOREIGN KEY ("Pjud_NumeroProcesso_id") REFERENCES "Processos"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "DocumentosAnexados" ADD CONSTRAINT "DocumentosAnexados_Danex_Usuario_fkey" FOREIGN KEY ("Danex_Usuario") REFERENCES "Usuarios"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "DocumentosAnexados" ADD CONSTRAINT "DocumentosAnexados_Danex_NumeroProcesso_id_fkey" FOREIGN KEY ("Danex_NumeroProcesso_id") REFERENCES "Processos"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "Transferencias" ADD CONSTRAINT "Transferencias_Tran_NumeroProcesso_id_fkey" FOREIGN KEY ("Tran_NumeroProcesso_id") REFERENCES "Processos"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
